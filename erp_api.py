...
# Conversion des dates et extraction du mois
        lots_df["date_enregistrement"] = pd.to_datetime(lots_df_filtered["date_enregistrement"], errors="coerce")
        lots_df["Mois"] = lots_df_filtered["date_enregistrement"].dt.month_name()
        lots_df["Mois"] = lots_df_filtered["Mois"].map({'January': 'Janvier', 'February': 'Février', 'March': 'Mars', 'April': 'Avril', 'May': 'Mai', 'June': 'Juin', 'July': 'Juillet', 'August': 'Août', 'September': 'Septembre', 'October': 'Octobre', 'November': 'Novembre', 'December': 'Décembre'})
